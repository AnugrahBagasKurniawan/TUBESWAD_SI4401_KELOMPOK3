...
<body>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="nama_produk">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <button type="submit" name="submit" class="btn btn-primary">Tambah Katalog</button>
        </div>
    </form>
</body>