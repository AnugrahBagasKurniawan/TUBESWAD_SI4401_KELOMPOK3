...
<body>
    <div class="header">
        <ul class="navbar">
            ...
            <li><a href="" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Login</a>
                <ul class="dropdown-menu">
                    <li><a href="LoginPengguna.php" class="dropdown-item">Pengguna</a></li>
                    <li><a href="LoginPegawai.php" class="dropdown-item">Pegawai</a></li>
                </ul>
            </li>
        </ul>
